...
| Name | What it is | Why |
|------|-----------|-----|
| **Sequent** | The project | Latin for "change" — the engine observes change |
...
The CLI is named after the action it performs, not the project it belongs to. When you type `wikihistory analyze "Bitcoin"`, the meaning is self-evident: analyze the wiki history of Bitcoin. `varia analyze` would require prior knowledge of what Sequent is.
...
- Use `Sequent` (capital V) as the project name in prose
