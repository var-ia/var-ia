const HEDGING_MARKERS: Record<string, string[]> = {
  en: [
    ...
    "reportedly", "allegedly", "purportedly", "ostensibly",
    "some sources", "some experts",
    "it has been suggested", "it is believed", "it is thought", "it is claimed",
    "is believed to", "is thought to", "is said to",
    "appears to", "seems to", "suggests that",
    "possibly", "presumably", "arguably",
  ],
  de: [
    "angeblich", "möglicherweise", "vermutlich", "scheinbar", "wahrscheinlich",
    "es wird angenommen", "es heißt", "es heisst", "soll", "könnte", "dürfte",
    "angeblich", "mutmaßlich", "mutmasslich",
  ],
  fr: [
    "prétendument", "soi-disant", "présumé", "peut-être", "possiblement",
    "vraisemblablement", "il est suggéré", "il paraît", "il parait",
    "pourrait", "serait", "devrait",
  ],
  ja: [
    "かもしれない", "だろう", "と考えられる", "と思われる", "らしい",
    "可能性がある", "可能性が高い", "と考えられている",
  ],
  ar: [
    "ربما", "قد", "من المحتمل", "يُعتقد أن", "يُقال إن",
  ],
};

const CERTAINTY_MARKERS: Record<string, string[]> = {
  en: [
    "confirmed", "established", "demonstrated", "proven", "proved",
    "widely accepted", "widely recognized",
    "definitively", "conclusively", "unequivocally", "indisputably",
    "is known to", "it is established", "it has been shown",
    "there is no doubt", "beyond doubt",
  ],
  de: [
    "bewiesen", "nachgewiesen", "zweifellos", "unbestritten", "eindeutig",
    "es ist erwiesen", "es steht fest", "unwiderlegbar",
  ],
  fr: [
    "prouvé", "démontré", "établi", "incontestablement",
    "sans aucun doute", "il est démontré", "indubitablement",
  ],
  ja: [
    "確か", "確実", "明らか", "間違いない", "証明された", "実証された",
    "間違いなく",
  ],
  ar: [
    "مؤكد", "بالتأكيد", "لا شك", "من المؤكد", "مُثبت", "مُؤكَّد",
  ],
};
