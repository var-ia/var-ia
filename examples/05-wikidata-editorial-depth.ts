 ...
 *
 * Refract tracks the full edit history: when a claim first appeared,
...
console.log(`Refract tells you the citation history:`);
console.log();
...
console.log("Refract shows the full editorial journey — sources that were tried,");
